...
## TOPIC 2: IAM USER
### User
![IAM user](https://github.com/user-attachments/assets/3d8014cf-89df-4ad4-a33a-2cb88664d602)

### group
![groups](https://github.com/user-attachments/assets/0a6bfaad-4214-448a-b3e8-ac02b4452f3c)

### programmatic access to user
![programmatic access](https://github.com/user-attachments/assets/6ccf7840-1a00-40c5-b213-a5eda4859a91)

## TOPIC 3: S3
### Bucket creation
![Bucket](https://github.com/user-attachments/assets/6b256c5f-6a16-4bee-b918-d612e2b01cac)

### public access of the bucket
![Public access to the bucket](https://github.com/user-attachments/assets/481e9a21-6ef0-4cb2-98ce-25f2f6ac4556)

### life cycle
![life cycle](https://github.com/user-attachments/assets/ce7945ab-c3d0-4bbb-8122-f947330be027)

### versioning
![Versioning](https://github.com/user-attachments/assets/3a81ddf8-59dd-4309-b77e-2a13b03f7700)

### replication
#### replication 1
![Replication1](https://github.com/user-attachments/assets/793116e1-e4e2-4aa2-a26d-839d33443fc4)
#### replication 2
![Replication2](https://github.com/user-attachments/assets/f23129a0-cd46-4f48-a648-21a5502dd453)

## TOPIC 3: EC2
### creation on linux machine - connect it and showing ip address
![creation of linux machine](https://github.com/user-attachments/assets/23762c74-30f2-4843-ae00-6a384c7621cb)

### creation of windows machine
![creation of windows machine](https://github.com/user-attachments/assets/e4ae4047-0310-481f-9bae-04602930bd46)

## TOPIC 4:EBS
### changing the volume size of linux machine
#### output 1:
![changing volume before](https://github.com/user-attachments/assets/1f1384b5-c915-4c38-bed8-5ed63218e225)

#### output 2:
![changing volume after](https://github.com/user-attachments/assets/56dd3fb1-6eb7-4caf-a449-3d106f13111b)

### snapshot
![Snapshot](https://github.com/user-attachments/assets/db4b2325-8570-4a02-8f95-77b19b0a30cc)

### ami
![AMI](https://github.com/user-attachments/assets/9d1223f3-0c44-4270-bdb6-f78c05e38b21)

### copied ami and ec2 created in another region
#### output 1:
![copied ami and ec2 1](https://github.com/user-attachments/assets/bc5adaa8-d266-46e8-a23d-3f31540c6118)

#### output 2:
![copied ami and ec2 2](https://github.com/user-attachments/assets/cff34a0b-8378-4196-b0ba-2f450b70dfd7)
...
#### output 1:
![creation file system 1](https://github.com/user-attachments/assets/fe333072-abc7-4a09-ada6-71dd6917327f)
#### output 2:
